export function CardBase({ children }) {
    return (
        <div className='m-4 flex justify-center items-center'>
            <div className='bg-white container lg:mx-auto max-w-sm border-black border-2 rounded-lg shadow-md px-8 pt-6 pb-8 mb-4'>
                {children}
            </div>             
        </div>
    )
...
function CardLinkName({ text }) {
    return (
        <p className="absolute text-xl inset-y-0 left-10 flex items-center px-2">
            {text}
        </p>
    )
}
