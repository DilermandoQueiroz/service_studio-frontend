...
import { IPostClient, IPostProvider } from '../../types';
...
export function FormLogin({ children }) {
    ...
    const { signInUserWithEmailAndPassword } = AuthService;
    ...
    const myOnSubmit: any = async (submit) => {
        try {
            await signInUserWithEmailAndPassword(submit.email, submit.password)
            router.push("/")
        } catch (err) {
            console.log(err)
        }
        ...
        <div className='m-4 px-4 flex justify-center items-center pt-20'>
            <form className='bg-white container lg:mx-auto max-w-sm border-black border-2 rounded-lg shadow-md px-8 pt-6 pb-8 mb-4' onSubmit={handleSubmit(myOnSubmit)}>
                <div className='mb-4 flex'>
                    <h1 className='text-2xl font-bold dark:text-black'>Logar</h1>
                </div>
...
export function FormProvider({ children }) {
    ...
    return (
        <>
            <div className='mx-4 px-4 flex justify-center items-center pt-10'>
                <form className='bg-white container lg:mx-auto max-w-sm border-black border-2 rounded-lg shadow-md px-3.5 py-3.5 mb-4' onSubmit={handleSubmit(myOnSubmit)}>
                    <div className='mb-4 flex'>
