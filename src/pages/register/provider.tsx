...
import { IPostClient, IPostProvider } from '../../types/index'
...
const RegisterProvider = () => {
  ...
  const { control, register, handleSubmit } = useForm<IPostProvider>();
      ...
      <form className='container lg:mx-auto max-w-sm' onSubmit={handleSubmit(myOnSubmit)}>
        ...
        <div className="relative mb-6">
          ...
          <div className="relative w-full">
            ...
            <input {...register("password", { required: true })} className="bg-white border-2 border-black border-b-4 text-black-900 text-sm rounded-lg focus:ring-black focus:border-white focus:border-2 block w-full p-2.5" id="password" type={passwordHidden ? "password" : "text"} />
          </div>
        </div>
        <div className='relative mb-6'>
        {
